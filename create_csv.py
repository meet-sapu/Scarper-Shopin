...
if __name__ == "__main__":
    ...
    json_file = "/Users/MeetSaparia/Documents/All_new.json"  # Replace with the actual JSON file path
    csv_file = "new_products_24-12-2024.csv"  # Replace with the desired CSV output path
